...
set rtlPath "/home/linux/ieng6/ee260bwi23/helong/final_project/ece260_project/syn/verilog"
...
read_sdc constraints/fullchip.sdc
...
write -format verilog -hier -output [format "%s%s%s"  netlist/ $top_module .out.v]
